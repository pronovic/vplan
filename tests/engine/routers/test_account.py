...
class TestRoutes:
    ...
    @patch("vplan.engine.routers.account.st_schedule_immediate_refresh")
    ...
    def test_delete_account(self, db_delete_account, db_retrieve_all_plans, db_update_plan_enabled, st_schedule_immediate_refresh):
        plans = ["a"]
        ...
        st_schedule_immediate_refresh.assert_called_once_with(plan_name="a")
